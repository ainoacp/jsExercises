...
por gender = 'RPG' usando .filter() y usa .reduce() 
para conseguir la media de sus .score. La función .find() 
también podría ayudarte para el contrar el genero 'RPG' 
en el array .gender.*/
...
const rpgScore = rpgVideogames.reduce((acc, rpgVideogame) => acc + rpgVideogame.score, 0);
console.log(rpgScore);
const rpgAverage = rpgScore / rpgVideogames.length;
